...
### ディアボロス ###
        ...
        value_i = {
            ...
            6 :  ['繪師: 菖蒲-pixiv',       'https://i.imgur.com/L9xOGr6.jpg']
        }
        line_bot_api.reply_message(event.reply_token,[TextSendMessage(text = value_i[i% len(value_i)+1][0]),ImageMessageURL(value_i[i% len(value_i)+1][1])])
...
# n網
        ...
        if((eval(num))==228922 or (eval(num))==173156 or (eval(num))==196970):
            ...
            line_bot_api.reply_message(event.reply_token,getData(value_i[i% len(value_i)+1],("https://nhentai.net/g/"+(267232+str(i*32))),267232+str(i*32)))
# 車號範圍變更
