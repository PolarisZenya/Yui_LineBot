...
#主要判斷列
    ...
    ### 小小甜心 ###
            ...
            value_i = [
                ['繪師: @PoLa1021_-twitter',  'https://i.imgur.com/SDdCPdd.jpg'],
    ...
    ### 美食殿堂 ###
            ...
            value_i = [
                ...
                [line_bot_api.reply_message(event.reply_token,[TextSendMessage(text= '是可可蘿啦...(可可蘿哭倒路邊'),ImageMessageURL('https://i.imgur.com/gIF9vdY.png')])],
            ]
            value_i[i% len(value_i)][0]
            ...
            value_i = [
                ...
                ['繪師: セーリュー-pixiv',  'https://i.imgur.com/QrE3zQM.jpg'],
    ...
    ### 角色 (其他) ###
            ...
            value_i = [
                ...
                ['繪師: ぐっち庵-pixiv',      'https://i.imgur.com/O3N6mCH.jpg'],
                ['繪師: AJ-pixiv',           'https://i.imgur.com/nnT8dGX.jpg'],
