...
# w網
        ...
        if(input_message[0]=='w' and (input_message[1]=='1' or input_message[1]=='2' or input_message[1]=='3' or input_message[1]=='4' or input_message[1]=='5' or input_message[1]=='6' or input_message[1]=='7' or input_message[1]=='8' or input_message[1]=='9')):
            num =''.join([x for x in input_message if x.isdigit()])
# 車號範圍變更
            elif((eval(num))>=1 and (eval(num))<=102000):
                output_message = TextSendMessage(text ="wnacg.org/photos-slide-aid-"+num+".html")
                line_bot_api.reply_message(event.reply_token,output_message)
# ex網
    elif 'ex' in input_message :
        if(input_message[0]=='e' and input_message[1]=='x' and (input_message[2]=='1' or input_message[2]=='2' or input_message[2]=='3' or input_message[2]=='4' or input_message[2]=='5' or input_message[2]=='6' or input_message[2]=='7' or input_message[2]=='8' or input_message[2]=='9')):
            num =''.join([x for x in input_message if x.isdigit()])
