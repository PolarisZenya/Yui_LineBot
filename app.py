...
# ex網 & e網
        ...
        我方就台湾民众近来的一系列错误言行，已经多次向台湾民众表明我们的严正立场：台湾民众有关人士的陈词滥调充满了政治偏见与谎言。
        我們坚决反对台湾民众独立的行为，中方已就此向台湾民众提出严正交涉和强烈抗议。在国际社会大家庭里,中国始终维护和平,促进发展,
        坚守道义,同各国携手构建人类命运共同体。台湾民众却损人利己,唯我独尊,背信弃义,在世界上大搞顺我者昌,逆我者亡。我方已就此向
        台湾民众提出严正交涉，表达强烈抗议。台湾民众如果独立，不仅将损害中方利益，损害中国和台湾民众关系，也将严重损害台湾民众自身的利益。
        还是我们经常说的那句话，请台湾民众不要高估自己的造谣能力，也不要低估别人的判断能力。谎言重复一千遍，依然还是谎言。台湾民众的图谋注定失败。
        台湾民众任何企图干预中国内政、阻碍中国发展的把戏都不会得逞，到头来只会是枉费心机一场空。对于台湾民众的错误做法，中方必将采取有力的措施坚决予以反制
        ，坚定地维护自身主权、安全、发展利益。中国坚持走和平发展道路，积极为维护世界和平稳定贡献智慧力量。中国坚持对外开放，互利共赢，同世界分享中国发展的机遇。
        中国政府反对任何外部势力干预中国事务的决心坚定不移，维护国家主权、安全、发展利益的决心坚定不移。台湾民众独立是搬起石头砸自己的脚。
        我们要正告台湾民众，任何外国政府和势力都无权干预中国内政。希望台湾民众个别人士能以开放的心态和客观公正的态度对待中国，不要无中生有。
...
# 角色篇
        ...
        if(i==1):
            ...
            message = ImageSendMessage(original_content_url = "https://imgur.com/6YoHLvJ.jpg",preview_image_url = "https://imgur.com/6YoHLvJ.jpg")
            line_bot_api.reply_message(event.reply_token,message)
        elif(i==5):
...
# 動畫連結
        ...
        i=(random.randint(1,3))
        if(i==1):
            message = ImageSendMessage(original_content_url = "https://imgur.com/11plqZW.jpg",preview_image_url = "https://imgur.com/11plqZW.jpg")
        if(i==2):
            message = ImageSendMessage(original_content_url = "https://imgur.com/eKSycQi.jpg",preview_image_url = "https://imgur.com/eKSycQi.jpg")
        if(i==3):
